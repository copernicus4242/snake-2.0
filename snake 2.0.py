...
def game_loop(snake_color=(0, 255, 0), snake1_color=(0, 0, 255)):
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_w and direction1 != (0, CELL_SIZE):
                    ...
                    snake1_color = random.randrange(0, 255), random.randrange(0, 255), random.randrange(0, 255)
        ...
        if new_head[0] < 0 or new_head[0] >= WIDTH or new_head[1] < 0 or new_head[1] >= HEIGHT or new_head in snake[1:] or new_head in snake1 or new_head1[0] < 0 or new_head1[0] >= WIDTH or new_head1[1] < 0 or new_head1[1] >= HEIGHT or new_head1 in snake1[1:] or new_head1 in snake:
            return
